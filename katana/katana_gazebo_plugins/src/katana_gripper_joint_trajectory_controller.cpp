...
//  katana::sampleSplineWithTimeBounds(coefficients, duration, relative_time.toSec(), sample_pos, sample_vel, sample_acc);
  ...
  //ROS_INFO("Spline coefficients: a0: %f, a1: %f, a2: %f, a3: %f, a4: %f ", coefficients[0], coefficients[1], coefficients[2], coefficients[3], coefficients[4]);
	std::cout << "Spline coefficients: a0: %f, a1: %f, a2: %f, a3: %f, a4: %f " << std::endl;
